 <!--page title start-->
      ...
      @section('content')
      <section class="page-title  ptb-50" style="background:url({{asset('storage/'.App\Models\Hero::first()->image)}}); background-position:center; background-size:cover">
            <div class="container">
                    ...
                    <div class="col-md-8">
                      <div class="posts-content default-blog">
                        ...
                        <article class="post-wrapper">
                          <h2 class="font-20 border white-text bg-warning my-3 p-3"><b>{{$read->title}}</b></h2>
